...
In the definition (\ref{eq:vh_cons'n-def}) of $\rho$ let us convert
...
=
 \int \!d^4a\, \frac{P}{\rho} \sqrt{-g} J u^{\mu} u_{\mu}
               \frac{\partial \rho}{\partial z^\alpha} \delta z^\alpha \eqp
\ee
...
term_1 = \int \!d^4z\, \frac{P}{\rho}\sqrt{-g} \frac{\partial \rho}{\partial z^\alpha} \delta z^\alpha \eqp
\ee
...
term_2 =  \int \!d^4a\, \frac{P}{\rho} \sqrt{-g} J u^{\mu} u_{\mu}
               \frac{\partial \rho}{\partial {z^\alpha}_{,\lambda}} \delta{z^\alpha}_{,\lambda} \eqp
\ee
...
\be\label{eq:vh_J_minor}
  \delta J = \left( \frac{1}{3!}[\alpha \beta \gamma \delta][\lambda \tau \mu \nu]
           ...
           \equiv {J^\lambda}_{\alpha} {\delta z^\alpha}_{,\lambda} \eqp
\ee
...
\be\label{eq:vh_diff_J_minor}
  \frac{\partial}{\partial a^\lambda} {J^\lambda}_{\alpha} = 0 \eqp
\ee
  ...
  term_2 = -\int \!d^4a\, \po \frac{\partial}{\partial a^0}
           ...
           - \int \!d^4a\, \frac{\partial}{\partial z^\sigma}
                           \left(
                            \sqrt{-g} P
                           \right)
                           \frac{\partial z^\sigma}{\partial a^\lambda} {J^\lambda}_{\alpha} \eqp
\ee
...
Finally, we arrive at the fourth term in (\ref{eq:vh_tot_var_z}), which when expanded as
above yields

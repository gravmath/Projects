...
//******************************************************************************
//Name:  array NumIndices                                                      *
//                                                                             *
//Purpose:  return the number of indices associated with an array              *
//                                                                             *
//Takes:                                                                       *
//******************************************************************************
int array::NumIndices(void) const
{

  int ret_val;

  ret_val = p->num_indices;
...
//Allocate space for the range array
  ...
  for( i = 0; i < p->num_indices; i++) range[i] = p->range[i];
...
//******************************************************************************
double array::Val(int range1, ...) const
{
  double return_val;
  int *range, i;
...
//Takes: variable list of indices                                              *
//******************************************************************************
void array::Set(double value, int range1, ...)
{
  int *range, i;

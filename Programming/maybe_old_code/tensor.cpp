...
//Create a dummy tensor then Resize on the fly
  tensor sum(1,1);
  sum.Resize(p->num_indices, range);
...
//******************************************************************************
tensor tensor::Contract(tensor &B, int ind1, int ind2)
{

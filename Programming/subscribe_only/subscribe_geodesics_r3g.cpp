#include "\school\Programming\tensor++\tensor.hpp"
#include <dos.h>
#define NUM 2
#define STD_SCHW 1
#define PG_SCHW  2
...
void main(void)
{
  ...
  if( sim_parms.RHSOnly == 0 )
  {
    fprintf(log,"******R3G Subscibe Only Geodesics Run**********\n\n");
  }
  else
  {
...
void DW(double* r, double* s, tensor dW, SIM* sim_parms)
{
   ...
   y2 = (  v[0]*v[0] + v[1]*v[1] + v[2]*v[2] ) * ih2;
